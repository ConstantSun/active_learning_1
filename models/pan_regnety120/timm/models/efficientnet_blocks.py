...
def get_bn_args_tf():
    """
    Returns the args object for the args.
...
class SqueezeExcite(nn.Module):
    def __init__(self, in_chs, se_ratio=0.25, reduced_base_chs=None,
        ...
        Args:
            ...
            reduced_base_chs: (todo): write your description
            act_layer: (todo): write your description
            nn: (todo): write your description
            ReLU: (todo): write your description
            gate_fn: (todo): write your description
...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
        ...
        Args:
            ...
            in_chs: (int): write your description
            out_chs: (str): write your description
            dw_kernel_size: (int): write your description
            stride: (int): write your description
            dilation: (todo): write your description
            pad_type: (todo): write your description
            act_layer: (todo): write your description
            nn: (todo): write your description
            ReLU: (todo): write your description
            noskip: (list): write your description
            pw_kernel_size: (int): write your description
            pw_act: (todo): write your description
            se_ratio: (todo): write your description
    ...
    def forward(self, x):
        """
        Forward computation for forward.
...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
        ...
        Args:
            ...
            exp_kernel_size: (int): write your description
            pw_kernel_size: (int): write your description
            se_ratio: (todo): write your description
            se_kwargs: (dict): write your description
            norm_layer: (int): write your description
            ...
            BatchNorm2d: (todo): write your description
            norm_kwargs: (dict): write your description
            conv_kwargs: (dict): write your description
            drop_path_rate: (str): write your description
        """
...
class CondConvResidual(InvertedResidual):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
        ...
        Args:
            ...
            BatchNorm2d: (todo): write your description
            norm_kwargs: (dict): write your description
            num_experts: (int): write your description
            drop_path_rate: (str): write your description
        """
...
class EdgeResidual(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, exp_kernel_size=3, exp_ratio=1.0, fake_in_chs=0,
        ...
        Args:
            ...
            exp_kernel_size: (int): write your description
            exp_ratio: (float): write your description
            fake_in_chs: (todo): write your description
            stride: (int): write your description
            dilation: (todo): write your description
            pad_type: (todo): write your description
            act_layer: (todo): write your description
