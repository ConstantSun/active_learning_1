...
class ResBottleneck(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dilation=1, bottle_ratio=0.25, groups=1,
        ...
        Args:
            ...
            attn_last: (todo): write your description
...
class DarkBlock(nn.Module):
    ...
    def zero_init_last_bn(self):
        """
        Initialize the weight of the weights
    ...
    def forward(self, x):
        """
        Perform of - only drop - only drop.
...
class CrossStage(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, stride, dilation, depth, block_ratio=1., bottle_ratio=1., exp_ratio=1.,
        ...
        Args:
            ...
            block_ratio: (float): write your description
            bottle_ratio: (float): write your description
            exp_ratio: (float): write your description
            groups: (list): write your description
            first_dilation: (str): write your description
            down_growth: (todo): write your description
            cross_linear: (todo): write your description
            block_dpr: (todo): write your description
            block_fn: (todo): write your description
            ResBottleneck: (todo): write your description
...
def _cfg_to_stage_args(cfg, curr_stride=2, output_stride=32, drop_path_rate=0.):
    ...
    Args:
        ...
        curr_stride: (int): write your description
...
class CspNet(nn.Module):
    ...
    def __init__(self, cfg, in_chans=3, num_classes=1000, output_stride=32, global_pool='avg', drop_rate=0.,
        ...
        Args:
            ...
            stage_fn: (str): write your description
            CrossStage: (todo): write your description
            block_fn: (todo): write your description
            ResBottleneck: (todo): write your description
        """
        super().__init__()
...
def _create_cspnet(variant, pretrained=False, **kwargs):
    ...
    Args:
        variant: (str): write your description
