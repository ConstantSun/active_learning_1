...
def load_state_dict(checkpoint_path, use_ema=False):
    """
    Load checkpoint_path from checkpoint_path.

    Args:
        checkpoint_path: (str): write your description
        use_ema: (bool): write your description
    """
...
def load_checkpoint(model, checkpoint_path, use_ema=False, strict=True):
    """
    Load checkpoint checkpoint. checkpoint_path.
...
def resume_checkpoint(model, checkpoint_path, optimizer=None, loss_scaler=None, log_info=True):
    ...
    Args:
        ...
        loss_scaler: (todo): write your description
        log_info: (todo): write your description
    """
    resume_epoch = None
...
def load_custom_pretrained(model, cfg=None, load_fn=None, progress=False, check_hash=False):
    ...
    # Issue warning to move dataset if old env is set
...
def load_pretrained(model, cfg=None, num_classes=1000, in_chans=3, filter_fn=None, strict=True, progress=False):
    ...
    Args:
        ...
        filter_fn: (str): write your description
        strict: (bool): write your description
...
def adapt_model_from_string(parent_module, model_string):
    """
    Adapts a string from string of - > string

    Args:
        parent_module: (todo): write your description
        model_string: (str): write your description
    """
    separator = '***'
    state_dict = {}
...
def default_cfg_for_features(default_cfg):
    ...
    Args:
        default_cfg: (str): write your description
    """
...
def build_model_with_cfg(
    ...
    Args:
        ...
        default_cfg: (str): write your description
        model_cfg: (todo): write your description
        feature_cfg: (todo): write your description
        pretrained_strict: (bool): write your description
        pretrained_filter_fn: (bool): write your description
        pretrained_custom_load: (bool): write your description
    """
