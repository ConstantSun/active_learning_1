...
class SequentialAppendList(nn.Sequential):
    ...
    def forward(self, x: torch.Tensor, concat_list: List[torch.Tensor]) -> torch.Tensor:
        ...
        Args:
            ...
            concat_list: (list): write your description
...
class OsaBlock(nn.Module):
    ...
    def __init__(self, in_chs, mid_chs, out_chs, layer_per_block, residual=False,
        ...
        Args:
            ...
            mid_chs: (int): write your description
            out_chs: (str): write your description
            layer_per_block: (todo): write your description
            residual: (todo): write your description
            depthwise: (float): write your description
            attn: (todo): write your description
...
class OsaStage(nn.Module):
    ...
    def __init__(self, in_chs, mid_chs, out_chs, block_per_stage, layer_per_block, downsample=True,
        ...
        Args:
            ...
            mid_chs: (int): write your description
            out_chs: (str): write your description
            block_per_stage: (int): write your description
            layer_per_block: (todo): write your description
            ...
            ReLU: (todo): write your description
            drop_path_rates: (str): write your description
        """
...
def ese_vovnet19b_slim_dw(pretrained=False, **kwargs):
    """
    R calculate the vovnetnet19 network
...
def ese_vovnet19b_slim(pretrained=False, **kwargs):
    """
    R calculate the net19net19 network
...
def ese_vovnet57b(pretrained=False, **kwargs):
    """
    Vel factory function for vovnetnetnet57
...
def ese_vovnet99b(pretrained=False, **kwargs):
    """
    R calculate a vovnet99 network
...
def ese_vovnet39b_evos(pretrained=False, **kwargs):
    ...
    def norm_act_fn(num_features, **nkwargs):
        """
        R compute the cross - wise.

        Args:
            num_features: (int): write your description
            nkwargs: (dict): write your description
        """
