...
def get_norm_act_layer(layer_class):
    """
    Get the norm of the layer.

    Args:
        layer_class: (todo): write your description
    """
...
def create_norm_act(layer_type, num_features, apply_act=True, jit=False, **kwargs):
    """
    Create the norm of layer_type.

    Args:
        layer_type: (str): write your description
        num_features: (int): write your description
        apply_act: (str): write your description
        jit: (str): write your description
    """
...
def convert_norm_act_type(norm_layer, act_layer, norm_kwargs=None):
    """
    Convert norm_layer to the correct type.
