...
class BranchSeparables(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, stem_cell=False, padding=''):
        ...
        Args:
            ...
            kernel_size: (int): write your description
            stride: (int): write your description
            stem_cell: (todo): write your description
            padding: (str): write your description
        """
...
class CellBase(nn.Module):
    ...
    def cell_forward(self, x_left, x_right):
        """
        Perform forward cell.

        Args:
            self: (todo): write your description
            x_left: (todo): write your description
            x_right: (todo): write your description
        """
...
class CellStem0(CellBase):
    ...
    def __init__(self, in_chs_left, out_chs_left, in_chs_right, out_chs_right, pad_type=''):
        ...
        Args:
            self: (todo): write your description
            in_chs_left: (todo): write your description
            out_chs_left: (todo): write your description
            in_chs_right: (todo): write your description
            out_chs_right: (str): write your description
...
class Cell(CellBase):
    ...
    def __init__(self, in_chs_left, out_chs_left, in_chs_right, out_chs_right, pad_type='',
        ...
        Args:
            ...
            out_chs_right: (str): write your description
            pad_type: (todo): write your description
            is_reduction: (bool): write your description
            match_prev_layer_dims: (int): write your description
        """
