...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, stride=1, dilation=1, bottleneck_ratio=1, group_width=1, se_ratio=0.25,
        ...
        Args:
            ...
            bottleneck_ratio: (todo): write your description
            group_width: (todo): write your description
...
class RegNet(nn.Module):
    ...
    def _get_stage_params(self, cfg, default_stride=2, output_stride=32, drop_path_rate=0.):
        """
        Get stage stage params.

        Args:
            self: (todo): write your description
            cfg: (str): write your description
            default_stride: (str): write your description
            output_stride: (str): write your description
            drop_path_rate: (str): write your description
        """
