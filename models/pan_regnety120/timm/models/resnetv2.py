...
from models.pan_regnety120.timm.data import IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
...
def _cfg(url='', **kwargs):
    """
    Returns a dictionary of arguments. cfg configuration.
...
def make_div(v, divisor=8):
    """
    Make a numeric value to an integer.
...
class PreActBottleneck(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            bottle_ratio: (float): write your description
            stride: (int): write your description
            dilation: (todo): write your description
            first_dilation: (str): write your description
            groups: (list): write your description
            act_layer: (todo): write your description
            conv_layer: (int): write your description
            norm_layer: (int): write your description
            proj_layer: (todo): write your description
...
class ResNetStage(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, stride, dilation, depth, bottle_ratio=0.25, groups=1,
        ...
        Args:
            ...
            block_dpr: (todo): write your description
            block_fn: (todo): write your description
            PreActBottleneck: (todo): write your description
            act_layer: (todo): write your description
            conv_layer: (int): write your description
            norm_layer: (int): write your description
            block_kwargs: (dict): write your description
        """
...
def create_stem(in_chs, out_chs, stem_type='', preact=True, conv_layer=None, norm_layer=None):
    ...
    Args:
        ...
        preact: (str): write your description
        conv_layer: (str): write your description
        norm_layer: (int): write your description
    """
    stem = OrderedDict()
...
class ResNetV2(nn.Module):
    ...
    def __init__(self, layers, channels=(256, 512, 1024, 2048),
        ...
        Args:
            ...
            stem_chs: (todo): write your description
            stem_type: (str): write your description
            avg_down: (todo): write your description
            preact: (todo): write your description
            act_layer: (todo): write your description
            ...
            conv_layer: (int): write your description
            StdConv2d: (todo): write your description
            norm_layer: (int): write your description
            partial: (todo): write your description
            GroupNormAct: (todo): write your description
...
def resnetv2_50x3_bitm(pretrained=False, **kwargs):
    """
    R calculate resnetv2 resnet - layer.
...
def resnetv2_152x2_bitm(pretrained=False, **kwargs):
    """
    R calculate resnetv2 resnet - layer. r2 image.
...
def resnetv2_101x1_bitm_in21k(pretrained=False, **kwargs):
    """
    R calculate a 2 - d attention attention.
...
def resnetv2_152x4_bitm_in21k(pretrained=False, **kwargs):
    """
    R calculate a 2 - layer of 2 - density.
