...
from models.pan_regnety120.timm.data import IMAGENET_DPN_MEAN, IMAGENET_DPN_STD, IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
...
class CatBnAct(nn.Module):
    def __init__(self, in_chs, norm_layer=BatchNormAct2d):
        ...
        Args:
            ...
            BatchNormAct2d: (todo): write your description
        """
...
class DualPathBlock(nn.Module):
    def __init__(
        ...
        """
        Initialize c1d blocks

        Args:
            self: (todo): write your description
            in_chs: (int): write your description
            num_1x1_a: (int): write your description
            num_3x3_b: (int): write your description
            num_1x1_c: (int): write your description
            inc: (int): write your description
            groups: (list): write your description
            block_type: (str): write your description
...
class DPN(nn.Module):
    def __init__(self, small=False, num_init_features=64, k_r=96, groups=32,
        ...
        """
        Initialize kbn dataset.

        Args:
            self: (todo): write your description
            small: (todo): write your description
            num_init_features: (int): write your description
            k_r: (float): write your description
            groups: (list): write your description
            b: (int): write your description
            k_sec: (float): write your description
            inc_sec: (todo): write your description
            ...
            fc_act: (todo): write your description
