...
class SENet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, groups, reduction, stride=1,
        ...
        Args:
            ...
            reduction: (todo): write your description
            stride: (int): write your description
            downsample_kernel_size: (int): write your description
            downsample_padding: (int): write your description
        """
        downsample = None
...
def legacy_seresnet18(pretrained=False, **kwargs):
    """
    Vel factory function for fresnet network.
