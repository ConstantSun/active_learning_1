...
class Mlp(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        Args:
            ...
            hidden_features: (int): write your description
            out_features: (int): write your description
            act_layer: (todo): write your description
            nn: (todo): write your description
            GELU: (todo): write your description
            drop: (todo): write your description
        """
        super().__init__()
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        Args:
            ...
            qkv_bias: (float): write your description
            qk_scale: (float): write your description
            attn_drop: (todo): write your description
            proj_drop: (todo): write your description
        """
        super().__init__()
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        Args:
            ...
            dim: (int): write your description
            num_heads: (int): write your description
            mlp_ratio: (float): write your description
            qkv_bias: (float): write your description
            qk_scale: (float): write your description
            drop: (todo): write your description
            attn_drop: (todo): write your description
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768):
        ...
        Args:
            ...
            embed_dim: (int): write your description
        """
        super().__init__()
...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x):
        """
        Parameters ---------- x : array x : list of tokens.
...
class DistilledVisionTransformer(VisionTransformer):
    ...
    Paper: `Training dataset-efficient image transformers & distillation through attention` -
    ...
    def forward_features(self, x):
        """
        Parameters ---------- x : np. array [ batch_size )...
...
def resize_pos_embed(posemb, posemb_new):
    ...
    Args:
        posemb: (todo): write your description
        posemb_new: (todo): write your description
    """
...
def _create_vision_transformer(variant, pretrained=False, distilled=False, **kwargs):
    ...
    Args:
        ...
        distilled: (todo): write your description
    """
