...
def _parse_ksize(ss):
    """
    Parse a human readable string to integer.

    Args:
        ss: (str): write your description
    """
    if ss.isdigit():
        return int(ss)
    else:
...
def decode_arch_def(arch_def, depth_multiplier=1.0, depth_trunc='ceil', experts_multiplier=1, fix_first_last=False):
    """
    Decode a list of architecture architecture.

    Args:
        arch_def: (todo): write your description
        depth_multiplier: (todo): write your description
        depth_trunc: (todo): write your description
        experts_multiplier: (todo): write your description
        fix_first_last: (str): write your description
    """
    arch_args = []
...
class EfficientNetBuilder:
    ...
    def __init__(self, channel_multiplier=1.0, channel_divisor=8, channel_min=None,
        ...
        Args:
            ...
            channel_divisor: (todo): write your description
            channel_min: (todo): write your description
            output_stride: (str): write your description
            pad_type: (todo): write your description
            act_layer: (todo): write your description
            se_kwargs: (dict): write your description
    ...
    def _round_channels(self, chs):
        """
        Round the number of the channel.

        Args:
            self: (todo): write your description
            chs: (todo): write your description
        """
    ...
    def _make_block(self, ba, block_idx, block_count):
        ...
        Args:
            self: (todo): write your description
            ba: (todo): write your description
            block_idx: (str): write your description
            block_count: (todo): write your description
        """
