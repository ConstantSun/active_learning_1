...
class FeatureInfo:
    ...
    def __init__(self, feature_info: List[Dict], out_indices: Tuple[int]):
        """
        Initialize feature_indices.

        Args:
            self: (todo): write your description
            feature_info: (str): write your description
            out_indices: (int): write your description
        """
        prev_reduction = 1
    ...
    def from_other(self, out_indices: Tuple[int]):
        """
        Create a copy of the featurecollection.

        Args:
            self: (todo): write your description
            out_indices: (array): write your description
        """
...
class FeatureHooks:
    ...
    def __init__(self, hooks, named_modules, out_map=None, default_hook_type='forward'):
        """
        Initialize hook hooks.

        Args:
            self: (todo): write your description
            hooks: (todo): write your description
            named_modules: (str): write your description
            out_map: (str): write your description
            default_hook_type: (str): write your description
        """
        # setup feature hooks
    ...
    def _collect_output_hook(self, hook_id, *args):
        """
        Collect hooks from_id

        Args:
            self: (todo): write your description
            hook_id: (str): write your description
        """
...
def _module_list(module, flatten_sequential=False):
    """
    Return a list of all namedtuples.

    Args:
        module: (todo): write your description
        flatten_sequential: (bool): write your description
    """
...
def _get_return_layers(feature_info, out_map):
    ...
    Args:
        feature_info: (todo): write your description
        out_map: (todo): write your description
    """
...
class FeatureDictNet(nn.ModuleDict):
    ...
    def __init__(
        ...
        Args:
            ...
            out_indices: (int): write your description
            out_map: (str): write your description
            feature_concat: (str): write your description
            flatten_sequential: (todo): write your description
        """
...
class FeatureHookNet(nn.ModuleDict):
    ...
    def __init__(
        ...
        Args:
            ...
            out_indices: (int): write your description
            out_map: (str): write your description
            out_as_dict: (dict): write your description
            no_rewrite: (bool): write your description
            feature_concat: (str): write your description
            flatten_sequential: (todo): write your description
            default_hook_type: (str): write your description
        """
