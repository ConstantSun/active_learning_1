...
class DenseLayer(nn.Module):
    def __init__(self, num_input_features, growth_rate, bn_size, norm_layer=BatchNormAct2d,
        ...
        Args:
            ...
            num_input_features: (int): write your description
            growth_rate: (todo): write your description
            bn_size: (int): write your description
            norm_layer: (int): write your description
            BatchNormAct2d: (todo): write your description
            drop_rate: (float): write your description
            memory_efficient: (todo): write your description
        """
...
class DenseBlock(nn.ModuleDict):
    ...
    def forward(self, init_features):
        """
        Parameters ---------- init_features : np. all features.

        Args:
            self: (dict): write your description
            init_features: (todo): write your description
        """
...
class DenseTransition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features, norm_layer=nn.BatchNorm2d, aa_layer=None):
        ...
        Args:
            self: (todo): write your description
            num_input_features: (int): write your description
            num_output_features: (int): write your description
            norm_layer: (int): write your description
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16), bn_size=4, stem_type='',
        ...
        Args:
            self: (todo): write your description
            growth_rate: (todo): write your description
            block_config: (todo): write your description
            bn_size: (int): write your description
            ...
            drop_rate: (float): write your description
            memory_efficient: (todo): write your description
            aa_stem_only: (bool): write your description
        """
...
def _filter_torchvision_pretrained(state_dict):
    """
    Filter out the state_dict that match the state.
