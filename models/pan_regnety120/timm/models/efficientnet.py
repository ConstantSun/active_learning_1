...
from models.pan_regnety120.timm.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, block_args, num_classes=1000, num_features=1280, in_chans=3, stem_size=32,
        ...
        Args:
            ...
            stem_size: (int): write your description
            ...
            fix_stem: (str): write your description
    ...
    def as_sequential(self):
        """
        Convert the layers in the layers.
...
def _create_effnet(model_kwargs, variant, pretrained=False):
    ...
    Args:
        model_kwargs: (dict): write your description
