...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, cardinality=1, base_width=64,
        ...
        Args:
            ...
            reduce_first: (str): write your description
            dilation: (todo): write your description
            first_dilation: (str): write your description
            ...
            attn_layer: (todo): write your description
    ...
    def zero_init_last_bn(self):
        """
        Initialize the weight of the bus.
...
def drop_blocks(drop_block_rate=0.):
    """
    Drop all blocks that drop_block_rate block.

    Args:
        drop_block_rate: (todo): write your description
    """
    return [
        None, None,
...
def make_blocks(
    ...
    Args:
        block_fn: (todo): write your description
        channels: (int): write your description
        block_repeats: (todo): write your description
        inplanes: (str): write your description
        reduce_first: (bool): write your description
        output_stride: (str): write your description
        down_kernel_size: (int): write your description
        avg_down: (int): write your description
        drop_block_rate: (todo): write your description
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, in_chans=3,
        ...
        Args:
            ...
            cardinality: (array): write your description
            base_width: (str): write your description
            stem_width: (int): write your description
            stem_type: (str): write your description
            output_stride: (str): write your description
            block_reduce_first: (str): write your description
            down_kernel_size: (int): write your description
            avg_down: (todo): write your description
            act_layer: (todo): write your description
            nn: (todo): write your description
            ReLU: (todo): write your description
            norm_layer: (int): write your description
            ...
            zero_init_last_bn: (bool): write your description
            block_args: (dict): write your description
        """
...
def ig_resnext101_32x8d(pretrained=True, **kwargs):
    """Constructs a ResNeXt-101 32x8 model pre-trained on weakly-supervised dataset
...
def ig_resnext101_32x16d(pretrained=True, **kwargs):
    """Constructs a ResNeXt-101 32x16 model pre-trained on weakly-supervised dataset
    and finetuned on ImageNet from Figure 5 in
    `"Exploring the Limits of Weakly Supervised Pretraining" <https://arxiv.org/abs/1805.00932>`_
    Weights from https://pytorch.org/hub/facebookresearch_WSL-Images_resnext/
    """
...
def ig_resnext101_32x32d(pretrained=True, **kwargs):
    """Constructs a ResNeXt-101 32x32 model pre-trained on weakly-supervised dataset
    and finetuned on ImageNet from Figure 5 in
    `"Exploring the Limits of Weakly Supervised Pretraining" <https://arxiv.org/abs/1805.00932>`_
    Weights from https://pytorch.org/hub/facebookresearch_WSL-Images_resnext/
    """
...
def ig_resnext101_32x48d(pretrained=True, **kwargs):
    """Constructs a ResNeXt-101 32x48 model pre-trained on weakly-supervised dataset
    and finetuned on ImageNet from Figure 5 in
    `"Exploring the Limits of Weakly Supervised Pretraining" <https://arxiv.org/abs/1805.00932>`_
    Weights from https://pytorch.org/hub/facebookresearch_WSL-Images_resnext/
    """
...
def seresnet50tn(pretrained=False, **kwargs):
    """
    Vel factory function to create a resnet50 model
