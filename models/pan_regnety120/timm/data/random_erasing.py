...
def _get_pixels(per_pixel, rand_color, patch_size, dtype=torch.float32, device='cuda'):
    ...
    Args:
        per_pixel: (str): write your description
        rand_color: (str): write your description
...
class RandomErasing:
    ...
    def __init__(
        ...
        Args:
            ...
            min_area: (int): write your description
            max_area: (int): write your description
            min_aspect: (int): write your description
            max_aspect: (int): write your description
    ...
    def _erase(self, img, chan, img_h, img_w, dtype):
        ...
        Args:
            ...
            chan: (todo): write your description
