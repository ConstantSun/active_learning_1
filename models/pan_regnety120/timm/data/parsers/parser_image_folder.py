...
def find_images_and_targets(folder, types=IMG_EXTENSIONS, class_to_idx=None, leaf_name_only=True, sort=True):
    """
    Find images and returns images in - subdir.

    Args:
        folder: (str): write your description
        types: (str): write your description
        IMG_EXTENSIONS: (str): write your description
        class_to_idx: (str): write your description
        leaf_name_only: (str): write your description
...
class ParserImageFolder(Parser):
    ...
    def _filename(self, index, basename=False, absolute=False):
        """
        Returns the filename of the given index.
