...
class ConvBnRelu(nn.Module):
    def __init__(
        ...
        Args:
            ...
            add_relu: (todo): write your description
            interpolate: (todo): write your description
        """
...
class FPABlock(nn.Module):
    def __init__(
        ...
        Args:
            ...
            in_channels: (int): write your description
            out_channels: (int): write your description
            upscale_mode: (str): write your description
        """
...
class PANDecoder(nn.Module):
    ...
    def __init__(
        ...
        Args:
            self: (todo): write your description
            encoder_channels: (str): write your description
